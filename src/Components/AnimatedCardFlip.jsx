...
const AnimatedCardFlip = () => {
    ...
    // value animation a share korar jonno ay hook use kore

    const frontImage = require('../Img/front.jpg');
    const backImage = require('../Img/back.jpg');

    const animatedStyleFront = useAnimatedStyle(() => {
        // ay hook use kore style kemon hobe te thik kore
        return{
            transform: [
                { perspective: 1000 },
    ...
    const handleFlip = () => {
      ...
      //  flip value ta change korar jonno 
    };
  return (
